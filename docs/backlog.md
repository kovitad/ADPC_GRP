...
| A5 | Shelter loader for `ddpm_shelters`, mapping the truncated Thai fields, membership decided by geometry, mismatches reported not hidden | M | Field meanings, DEP-06 | A district's shelters load with a stated count of rejected or suspicious points |
