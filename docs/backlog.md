...
| U7 | ~~**The assistant does not remember.**~~ Owner: "i ask same question he should not look up mcp again?" It forgot after 5-10 minutes, on a restart, a new sign-in or a closed tab~~ — **done 25 Sep**, commit `241313b`, ADR-0029: SIG evidence per person, Hub and place in the database for 60 minutes, usable with SIG disconnected; receipts still need evidence under 5 minutes old; conversation restored from the server; "New conversation" forgets both | M | — | A second question about a district makes no SIG call, after a restart too; a closed tab comes back with its conversation; nothing is published on evidence older than 5 minutes |
